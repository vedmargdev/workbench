...
@include('offlinetest::template.user.test.create-popup')
@include('offlinetest::template.user.test.delete-popup')
@endsection
...
@section('app-js')
    <script src="{{ asset('vendor/offlinetest/js/offline-test.js?v=' . time()) }}"></script>
@endsection
